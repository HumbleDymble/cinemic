            ...
            >
              ...
              >
                {["admin", "moderator"].includes(user?.role ?? "user") && (
                  <Button
                    component={Link}
                    to={user?.role === "admin" ? "/admin/users" : "/moderator/users"}
                    size="small"
                    variant="outlined"
                    sx={{
                ...
                {userInitial ? (
                  <>
                    ...
                    >
                      <MenuItem component={Link} to="/auth/settings" onClick={onMenuClose}>
                        <PersonIcon sx={{ mr: 1 }} /> {t("widgets.navbar.settings")}
                      </MenuItem>

                      <MenuItem component={Link} to="/user/profile" onClick={onMenuClose}>
                        <PersonIcon sx={{ mr: 1 }} /> {t("widgets.navbar.userProfile")}
                      </MenuItem>

                      <MenuItem component={Link} to="/user/random-title" onClick={onMenuClose}>
                        <AnimatedCasinoIcon />
                        {t("widgets.navbar.randomTitle")}
                      </MenuItem>

                      <MenuItem component={Link} to="/title/guess" onClick={onMenuClose}>
                        <AnimatedQuizIcon />
                  ...
                  <Button component={Link} to="/auth/signin" variant="outlined" size="small">
