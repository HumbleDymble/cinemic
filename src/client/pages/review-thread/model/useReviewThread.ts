...
import { type NotificationId, useMarkAsReadMutation } from "@/client/entities/notification";
...
export const useReviewThread = () => {
  ...
  useEffect(() => {
    const notificationId = searchParams.get("notify_id");
  ...
  }, [searchParams, pathname, markNotificationsSeen, router]);
