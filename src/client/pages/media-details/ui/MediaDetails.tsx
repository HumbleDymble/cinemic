...
import type { Image, ImdbData, PersonInMovie, YearRange } from "@/entities/media-detail";
import { useGetImagesForTitleQuery, useGetImdbTitleQuery, useGetMediaDetailsQuery, } from "@/entities/media-detail";
